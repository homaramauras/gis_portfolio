...
########################### MAKE A MAP OF SECT BY GOVERNORATE
#### Maybe we can make one map for every sect and plot them side by side
...
```{r 3.5_attack_type}
#summarizing attack types

attack_type_summary <- combined_summary_sf %>%
